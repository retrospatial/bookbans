...
const css$8 = {
  code: ".chart-details.svelte-d9zr8r{text-align:center}.chart-title.svelte-d9zr8r{font-family:'American Typewriter', sans-serif;margin-top:4rem;margin-bottom:0.25rem;font-size:24px}.chart-source.svelte-d9zr8r{font-family:'Roboto Mono', monospace;text-align:left;font-size:14px;font-weight:800;color:var(--color-gray-600);margin-bottom:4rem;text-transform:uppercase}",
  map: `{"version":3,"file":"ChartDetails.svelte","sources":["ChartDetails.svelte"],"sourcesContent":["<script>\\n    export let title = \\"\\";\\n    export let source = \\"\\"\\n<\/script>\\n\\n<div class = \\"chart-details\\">\\n    {#if title}\\n        <h2 class = \\"chart-title\\">{title}</h2>\\n    {/if}\\n    {#if source}\\n        <p class = \\"chart-source\\">{source}</p>\\n    {/if}\\n</div>\\n\\n<style>\\n    .chart-details {\\n        text-align: center;\\n    }\\n\\n    .chart-title {\\n        font-family: 'American Typewriter', sans-serif;\\n        margin-top: 4rem;\\n        margin-bottom: 0.25rem;\\n        font-size: 24px;\\n    }\\n\\n    .chart-source {\\n        font-family: 'Roboto Mono', monospace;\\n        text-align: left;\\n        font-size: 14px;\\n        font-weight: 800;\\n        color: var(--color-gray-600);\\n        margin-bottom: 4rem;\\n        text-transform: uppercase;\\n    }</style>"],"names":[],"mappings":"AAeI,4BAAe,CACX,UAAU,CAAE,MAChB,CAEA,0BAAa,CACT,WAAW,CAAE,qBAAqB,CAAC,CAAC,UAAU,CAC9C,UAAU,CAAE,IAAI,CAChB,aAAa,CAAE,OAAO,CACtB,SAAS,CAAE,IACf,CAEA,2BAAc,CACV,WAAW,CAAE,aAAa,CAAC,CAAC,SAAS,CACrC,UAAU,CAAE,IAAI,CAChB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,KAAK,CAAE,IAAI,gBAAgB,CAAC,CAC5B,aAAa,CAAE,IAAI,CACnB,cAAc,CAAE,SACpB"}`
};
const ChartDetails = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="chart-details svelte-d9zr8r">${title ? `<h2 class="chart-title svelte-d9zr8r">${escape(title)}</h2>` : ``} ${source ? `<p class="chart-source svelte-d9zr8r">${escape(source)}</p>` : ``} </div>`;
});
const css$7 = {
...
function version() {
  ...
  console.log(`build: ${"2024-10-24-17:12"}`);
  console.log("--- --- --- --- --- ---");
}
